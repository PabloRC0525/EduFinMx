...
<body class="bg-white">
  ...
  <header class="bg-neutral-950 shadow px-6">
    ...
    <img src="imagenes/logo.jpg" alt="Logo" class="h-8 mr-2">
      ...
      <button class="px-2 w-15 items-center rounded-md text-gray-600  hover:text-amber-300" onclick="Home()">
      ...
      <button class="px-2 w-15 items-center rounded-md text-gray-600 hover:text-amber-300" onclick="Lecciones()">
      ...
      <button onclick="Declaraciones()"class="px-2px-2 w-15 items-center justify-center rounded-md text-gray-600 hover:text-amber-300">
        <svg class="justify-center w-full h-10 p-2"xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<button onclick="Ahooro()"class="px-2px-2 w-15 items-center justify-center rounded-md text-gray-600 hover:text-amber-300">
  <svg class="justify-center w-full h-10 p-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<script>
  function Ahooro() {
      ...
      <button onclick="perfil()"class="px-2px-2 w-15 items-center justify-center rounded-md text-gray-600 hover:text-amber-300">
