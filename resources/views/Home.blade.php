...
<div class="max-w-4xl mx-auto">
  ...
  <div class="flex flex-wrap justify-center mt-4">
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 p-4">
      <div class="bg-white shadow-md rounded-lg overflow-hidden flex items-center justify-center flex-col">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-20 w-20 text-amber-500">
        ...
        <p class="text-lg mt-2">Aprende a administrar tu dinero de manera efectiva.</p>
      </div>
    </div>
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 p-4">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-20 w-20 text-amber-500">
        ...
        <p class="text-lg mt-2">Mejora tu planificación financiera y alcanza tus metas.</p>
      </div>
    </div>
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 p-4">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-20 w-20 text-amber-500">
        ...
        <p class="text-lg mt-2">Domina conceptos clave como presupuesto, ahorro e inversión.</p>
      </div>
    </div>
    ...
    <div class="w-full md:w-1/2 lg:w-1/4 p-4">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-20 w-20 text-amber-500">
        ...
        <p class="text-lg mt-2">Obtén asesoramiento experto para superar tus desafíos financieros.</p>
      </div>
    </div>
  </div>
</div>
